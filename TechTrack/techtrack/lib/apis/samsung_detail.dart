...
class DetailSamsung extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailSamsung({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailSamsung> createState() => _DetailSamsungState();
}

class _DetailSamsungState extends State<DetailSamsung> {
