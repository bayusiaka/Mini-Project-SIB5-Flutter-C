...
class DetailXiaomi extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailXiaomi({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailXiaomi> createState() => _DetailXiaomiState();
}

class _DetailXiaomiState extends State<DetailXiaomi> {
