...
class DetailIphone extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailIphone({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailIphone> createState() => _DetailIphoneState();
}

class _DetailIphoneState extends State<DetailIphone> {
