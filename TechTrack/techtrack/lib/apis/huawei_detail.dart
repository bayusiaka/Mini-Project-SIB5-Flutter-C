...
class DetailHuawei extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailHuawei({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailHuawei> createState() => _DetailHuaweiState();
}

class _DetailHuaweiState extends State<DetailHuawei> {
