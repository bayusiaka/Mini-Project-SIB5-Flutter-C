...
class DetailVivo extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailVivo({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailVivo> createState() => _DetailVivoState();
}

class _DetailVivoState extends State<DetailVivo> {
