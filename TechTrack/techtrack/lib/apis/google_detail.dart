...
class DetailGoogle extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailGoogle({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailGoogle> createState() => _DetailGoogleState();
}

class _DetailGoogleState extends State<DetailGoogle> {
